...
public class ApiGetCall extends BaseAPI{
	...
	public void getUsers() {
		...
		APIRequestContext apiContext = initializeAPIConncetion();
		apiResponse = apiContext.get("https://gorest.co.in/public/v2/users");
	...
	public void getAUserWithQuaryParam() {
		...
		apiResponse = apiContext.get("https://gorest.co.in/public/v2/users", reqOpt);
